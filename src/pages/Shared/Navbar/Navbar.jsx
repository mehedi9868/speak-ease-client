...
const Navbar = () => {
    ...
    return (
        <div className="navbar sticky top-0 md:fixed z-50 md:bg-opacity-80 bg-[#262626]">
            <div className="navbar-start ml-5">
                <div className="dropdown">
                    <label tabIndex={0} className="btn btn-ghost text-white lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </label>
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-[#262626] rounded-md w-52">
                        {menu}
                    </ul>
                </div>
                <div>
                    <Link to="/">
                        <h2 className='text-gray-400 text-xl md:text-3xl font-bold' style={{ fontFamily: 'Kalam, cursive' }}>Speak Ease</h2>
                    </Link>
                </div>
            </div>
